...
execute as @a at @s positioned ~ ~-1 ~ run function common:ingame/farmland/is_on_farmland
execute as @a at @s positioned ~ ~-2 ~ run function common:ingame/farmland/is_on_farmland
...
tag @a[tag=have_slowfalling,tag=!farmland_protect] remove have_slowfalling
