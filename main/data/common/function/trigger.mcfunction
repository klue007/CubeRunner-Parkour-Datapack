...
execute if score @s tools matches 1.. if entity @s[tag=tools] run tellraw @s [{"text": "已隐藏快捷工具.","color": "gray"}]
...
execute if score @s tools matches 1.. if entity @s[tag=!tools,tag=!tools_hide] run tellraw @s [{"text": "已显示快捷工具.","color": "gray"}]
